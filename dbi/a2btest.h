...
#ifdef _WIN32
char *tpch_dir ="data/table_data/"; // windows dir where dbgen tpch files (extension *.tbl) can be found
#else
char *tpch_dir ="/cise/tmp/dbi_sp11/DATA/1G/"; // linux dir where dbgen tpch files (extension *.tbl) can be found
#endif
